...
export function RegistrarVideoEditor({
      ...
      <div className="space-y-2">
        ...
        {!videoUrl && (
          <div className="text-[10px] text-gray-400">
            Ссылка на Телемост ещё не указана. Нажмите «Редактировать»,
            чтобы добавить её.
          </div>
        )}
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="text-[10px] text-gray-400">
        Эти настройки определяют, как подключится врач к консультации. В будущем
        здесь можно будет показывать и ссылку для клиента.
      </div>
    </div>
  );
}
