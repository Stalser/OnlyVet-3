 ...
 * - Позволяет добавлять документ клиникой (текст + ссылка на файл).
 *
 * Позже вместо ссылки file_path можно будет привязать реальную загрузку файлов.
 */
export function RegistrarDocumentsBlock({
  ...
  async function handleAdd() {
    ...
    if (
      !window.confirm("Добавить документ к этой консультации?")
    ) {
      return;
    }
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl border border-dashed.border-gray-300 bg-gray-50 p-3 space-y-2">
            ...
            <div className="text-[11px] text-gray-500">
              Можно добавлять анализы, заключения, заметки по звонку и т.д. Позже сюда
              привяжем загрузку файлов.
            </div>
