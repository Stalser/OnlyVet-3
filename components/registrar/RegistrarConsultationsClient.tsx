    ...
    return appointments.filter((a) => {
      ...
      if (search.trim().length > 0) {
        ...
        const haystack = [
          ...
          a.serviceName || "",
          a.serviceCode || "",
          a.complaint || "",      // ← добавили поиск по жалобе
        ]
          .join(" ")
          .toLowerCase();
  ...
  return (
    <section className="rounded-2xl border bg-white p-4 space-y-4">
      <div className="flex flex-wrap.items-center justify-between gap-3">
        <div>
          <h2 className="text-base font-semibold">Все консультации и заявки</h2>
        ...
        <div className="flex.flex-wrap gap-2 text-xs">
          <input
            ...
            placeholder="Поиск по клиенту, питомцу, врачу, услуге или жалобе…"
        ...
        <table className="min-w-full text-xs">
          <thead>
            <tr className="border-b bg-gray-50 text-left text-[11px] uppercase.text-gray-500">
              ...
              <th className="px-2 py-2">Жалоба</th> {/* ← новая колонка */}
          ...
          <tbody>
            {filtered.map((a, index) => (
              ...
              >
                ...
                {/* Новая колонка — краткая жалоба */}
                <td className="px-2 py-2 align-top max-w-[200px]">
                  <div className="text-[11px] text-gray-700 line-clamp-3 whitespace-pre-line">
                    {a.complaint || "—"}
                  </div>
                </td>
