...
export default async function StaffSchedulePage() {
  ...
  const upcoming: Appointment[] = appointments.filter(
    (a: Appointment) => {
                  ...
                  <Link key={a.id} href={`/staff/appointment/${a.id}`}>
                    <div className="flex items-center justify-between rounded-xl border px-3 py-2 text-xs hover:bg-gray-50">
                      <div className="flex flex-col gap-0.5">
                        <span className="font_medium text-gray-900">
                          {a.startsAt
                ...
                <div className="space-y-1">
                  {dayAppointments
                    ...
                    .map((a) => (
                      ...
                      >
                        <div className="flex items-center justify_between rounded-xl border px-3 py-2 text-xs hover:bg-gray-50">
                          <div className="flex flex-col gap-0.5">
